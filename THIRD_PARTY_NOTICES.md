...
Screenplay Studio embeds Courier Prime for consistent professional screenplay output.

Copyright 2015 The Courier Prime Project Authors.

Courier Prime is licensed under the SIL Open Font License, Version 1.1. The complete license is distributed with the `@fontsource/courier-prime` package in this application's dependencies.
